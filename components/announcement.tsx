...
export async function AnnouncementBanner() {
  ...
  return (
    <div className="mx-auto w-full max-w-page px-3 pt-3 sm:px-6 lg:px-8">
      <p className="flex animate-fade-in items-center justify-center gap-2 rounded-xl bg-highlight-soft px-4 py-2 text-center text-sm font-medium text-highlight">
